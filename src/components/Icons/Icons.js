...
export function HomeIcon({ width = '3.2rem', height = '3.2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function HomeActiveIcon({ width = '3.2rem', height = '3.2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function UserGroupIcon({ width = '3.2rem', height = '3.2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function UserActiveGroupIcon({ width = '3.2rem', height = '3.2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function MapIcon({ width = '3.2rem', height = '3.2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function MapActiveIcon({ width = '3.2rem', height = '3.2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function LiveIcon({ width = '3.2rem', height = '3.2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function LiveActiveIcon({ width = '3.2rem', height = '3.2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function HeartIcon({ width = '2.4rem', height = '2.4rem', className }) {
    return (
...
export function CommentIcon({ width = '2.4rem', height = '2.4rem', className }) {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="currentColor">
            <path
                fillRule="evenodd"
...
export function ShareIcon({ width = '2.4rem', height = '2.4rem', className }) {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="currentColor">
            <path
                fillRule="evenodd"
...
export function UnpauseIcon({ width = '2.4rem', height = '2.4rem', className }) {
    return (
        <svg
            width={width}
            data-e2e=""
...
export function PauseIcon({ width = '2.4rem', height = '2.4rem', className }) {
    return (
        <svg
            viewBox="0 0 48 48"
            xmlns="http://www.w3.org/2000/svg"
...
export function MuteIcon({ width = '2.4rem', height = '2.4rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
export function SoundIcon({ width = '2.4rem', height = '2.4rem', className }) {
    return (
        <svg
            className={className}
            width={width}
